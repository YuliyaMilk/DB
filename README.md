Приложение №1 к Договору на создание программного обеспечения №__/20 от «__»___________ 2020 г.
...
Для врача: просмотр записей, назначение курса лечения, прием пациента.

Для пациента: запись на прием, регистрация на сайте, просмотр курса лечения.
...
Пациент сам вносит свои данные  с помощью сайта.
